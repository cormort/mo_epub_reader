...
const IMAGE_CACHE=`${PREFIX}-images-v2`;
const APP_SHELL=['./','./index.html','./changelog.html','./changelog.json','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-192-maskable.png','./icons/icon-512-maskable.png','./icons/apple-touch-icon.png','./icons/favicon-32.png'];
